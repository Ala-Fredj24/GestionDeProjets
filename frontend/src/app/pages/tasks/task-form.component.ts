    ...
    <section class="page">
      <div class="page-header">
        <div>
          ...
          <p>{{ modeEdition ? 'Mettre à jour une tâche existante' : 'Créer une tâche liée à un projet existant' }}</p>
        </div>
        ...
        <form [formGroup]="formulaire" (ngSubmit)="soumettre()">
          ...
          <div class="grid">
            ...
            <div class="field">
              ...
              <input id="responsable" type="text" formControlName="responsable" placeholder="Ex: Ali" />
            ...
            <div class="field full-width">
              ...
              <textarea id="description" formControlName="description" rows="4" placeholder="Décrire la tâche..."></textarea>
          ...
          <div class="actions">
            <button type="button" class="secondary-button" routerLink="/taches">
              Annuler
            </button>
            ...
            >
              {{ enregistrementEnCours ? 'Enregistrement...' : (modeEdition ? 'Mettre à jour la tâche' : 'Créer la tâche') }}
            </button>
          </div>
        </form>
      </div>
...
export class TaskFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.projectService.recupererTousLesProjets().subscribe({
      next: (data) => {
        this.projets = data;
  ...
  soumettre(): void {
    ...
    const operation = this.modeEdition && this.tacheId !== null
